...
Control Flow (if/switch/loops) is a Java 8 topic relevant in production and interviews. This page gives a concise reference and example.

## 2. Problem statement
Demonstrate Control Flow (if/switch/loops) with a small example and discuss edge cases.
