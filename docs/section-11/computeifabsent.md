...
Java 8 Map method `computeIfAbsent` reduces boilerplate map-update code.
...
## 6. Sample input
- Input: before = {a=1}
- Input: operation = computeIfAbsent
...
## 8. Output
- Output: stdout = (none)
- Output: after = {a=1, b=10}
- Output note: Computes value only when key is missing.
