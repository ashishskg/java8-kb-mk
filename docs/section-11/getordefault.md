...
Java 8 Map method `getOrDefault` reduces boilerplate map-update code.
...
public class MapApiDemo {
    public static void main(String[] args) {
        ...
        m.put("a", 1);
        System.out.println(m.getOrDefault("missing", -1));
        if (!"".equals("-1")) {
...
- Output: stdout = -1
- Output: after = {a=1}
- Output note: Returns default when key absent; does not mutate map.
