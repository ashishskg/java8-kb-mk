...
Java 8 Map method `putIfAbsent` reduces boilerplate map-update code.
...
- Output: stdout = (none)
- Output: after = {a=1}
- Output note: Existing value is kept; only inserts if key missing.
