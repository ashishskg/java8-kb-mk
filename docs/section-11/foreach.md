...
Java 8 Map method `forEach` reduces boilerplate map-update code.
...
- Output: stdout = a=1
b=2
- Output: after = {a=1, b=2}
- Output note: Iterates entries; use LinkedHashMap if you need deterministic iteration order.
